...
namespace UnanetApiSample.Controllers
{
    ...
    public class TimesheetsController : ControllerBase
    {
        // GET /rest/time
        [HttpGet]
        public IActionResult GetTimesheets([FromHeader(Name = "X-Una-App")] string? appHeader)
        {
        ...
        // GET /rest/time/{id}
        [HttpGet("{id}")]
        public IActionResult GetTimesheet(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetTimesheetAdjustments(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetTimesheetAttachment(int id, int attachmentId, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetTimesheetAttachments(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        [HttpGet("{id}/audit")]
        public IActionResult GetTimesheetAudit(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetAutoFill(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetDeletedAutoFill(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        [HttpGet("{id}/history")]
        public IActionResult GetTimesheetHistory(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetItemsAudit(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        [HttpGet("{id}/offline")]
        public IActionResult GetOfflineTimesheet(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetTimesheetProjectTypes(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        [HttpGet("{id}/projects")]
        public IActionResult GetTimesheetProjects(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetProjectLaborCategories(int id, int projectId, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetProjectLocations(int id, int projectId, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetTaskLaborCategories(int id, int taskId, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetTaskLocations(int id, int taskId, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        [HttpGet("{id}/validate")]
        public IActionResult ValidateTimesheet(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
