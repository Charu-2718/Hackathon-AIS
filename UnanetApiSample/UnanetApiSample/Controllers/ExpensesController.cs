...
namespace UnanetApiSample.Controllers
{
    ...
    public class ExpensesController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public IActionResult GetExpense(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
        ...
        public IActionResult GetExpenseAttachments(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetExpenseAttachment(int id, int attachmentId, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetExpenseDetail(int id, int detailId, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        [HttpGet("{id}/history")]
        public IActionResult GetExpenseHistory(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetMealCaps(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetPaymentMethods(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetProjectTypes(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        [HttpGet("{id}/projects")]
        public IActionResult GetExpenseProjects(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        [HttpGet("{id}/validate")]
        public IActionResult ValidateExpense(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        [HttpGet("projects")]
        public IActionResult GetProjectsByOwner([FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetVatLocations([FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
        ...
        public IActionResult GetVatLocation(int id, [FromHeader(Name = "X-Una-App")] string? appHeader)
        {
            if (string.IsNullOrEmpty(appHeader))
                return Unauthorized(new { error = "Missing X-Una-App header" });
